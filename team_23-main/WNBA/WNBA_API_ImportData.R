...
# Pull most recent 6 years of play by play data
tictoc::tic() 
...
tictoc::toc()
wnba_df <- bind_rows(wnba_pbp1,  wnba_pbp2)
write.csv(wnba_df,"wnba_pbp_2019-24.csv", row.names = FALSE)
...
tictoc::toc()
wnba_player_df <- bind_rows(wnba_player1,  wnba_player2)
...
tictoc::toc()
wnba_team_df <- bind_rows(wnba_team1,  wnba_team2)
write.csv(wnba_team_df,"wnba_teambox_2019-24.csv", row.names = FALSE)
...
tictoc::toc()
wnba_sched_df <- bind_rows(wnba_sched1,  wnba_sched2)
write.csv(wnba_sched_df,"wnba_schedule_2019-24.csv", row.names = FALSE)
